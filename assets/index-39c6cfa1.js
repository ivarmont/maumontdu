      ...
      e: for (var H = 0, X = C.length, er = X >>> 1; H < er; ) {
        ...
        if (0 > l(wl, z))
          yn < X && 0 > l(nr, wl)
            ? ((C[H] = nr), (C[yn] = z), (H = yn))
            : ((C[H] = wl), (C[hn] = z), (H = hn));
        else if (yn < X && 0 > l(nr, z)) (C[H] = nr), (C[yn] = z), (H = yn);
        else break e;
      }
    }
    return N;
  ...
  function E(C, N) {
    ...
    try {
      ...
      if (m !== null) var er = !0;
        ...
        var hn = t(c);
        hn !== null && gl(h, hn.startTime - N), (er = !1);
      }
      return er;
    } finally {
      (m = null), (p = z), (g = !1);
...
function Vc(e, n, t, r, l, o, u, i, s) {
  (Et = !1), (Or = null), $c.apply(Ac, arguments);
}
...
function tu(e, n, t, r) {
  if (Fr) {
    var l = mo(e, n, t, r);
    if (l === null) Il(e, n, r, jr, t), Zu(e, r);
    else if (tf(l, e, n, t, r)) r.stopPropagation();
    else if ((Zu(e, r), n & 4 && -1 < nf.indexOf(e))) {
      for (; l !== null; ) {
        var o = qt(l);
        if (
          (o !== null && zs(o),
...
var jr = null;
function mo(e, n, t, r) {
  if (((jr = null), (e = qo(r)), (e = Sn(e)), e !== null))
...
var Tf = He && "TextEvent" in window && !Ct,
  Is = He && (!uu || (Ct && 8 < Ct && 11 >= Ct)),
...
function As(e) {
  if (e.propertyName === "value" && ll(Ut)) {
    var n = [];
    Us(n, Ut, e, qo(e)), ws(Df, n);
  }
}
function Ff(e, n, t) {
  e === "focusin"
    ? (ui(), (_t = n), (Ut = t), _t.attachEvent("onpropertychange", As))
    : e === "focusout" && ui();
}
function jf(e) {
...
var Bf = He && "documentMode" in document && 11 >= document.documentMode,
  Fn = null,
  vo = null,
  xt = null,
  ho = !1;
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              h !== null &&
              ((d = h),
              f !== null && ((h = Dt(a, f)), h != null && S.push(Vt(a, h, d)))),
            F)
          )
            break;
          a = a.return;
...
function vn() {
  if (!jl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Cs(bo, vn), l);
    } finally {
      (O = n), (jl = !1);
    }
  }
...
function No(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = la), vu(e);
  var o = n.contextType;
  typeof o == "object" && o !== null
    ? (l.context = Ce(o))
...
function hu(e, n) {
  switch ((M(Wt, n), M(Ht, e), M(je, bt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Su(e, n, t, r, l, o) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (xr.current = e === null || e.memoizedState === null ? od : ud),
    (e = t(r, l)),
    Pt)
  ) {
    o = 0;
    do {
      if (((Pt = !1), (Qt = 0), 25 <= o)) throw Error(y(301));
      (o += 1),
        (G = K = null),
        (n.updateQueue = null),
        (xr.current = id),
...
function Oi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Nr(e, n), oa(n, t, r), No(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
    ...
    (u.state = p),
      ...
      i !== r || p !== s || ce.current || Ze
        ? (typeof v == "function" && (Po(n, t, v, r), (s = n.memoizedState)),
...
function Mi(e, n, t, r, l) {
  return bn(), cu(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
...
function cd(e, n, t, r, l, o, u) {
  ...
  if (((i = (u & e.childLanes) !== 0), ae || i)) {
    ...
    return Tu(), (r = Bl(Error(y(421)))), vr(e, n, u, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
  ...
  switch ((au(n), n.tag)) {
    ...
    case 6:
      if (e && n.stateNode != null) Ua(e, n, e.memoizedProps, r);
        ...
        if (((t = En(Wt.current)), En(je.current), pr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Ie] = n),
    ...
    case 4:
      return (
        nt(), Mo(e, n), e === null && At(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Bt], delete n[ko], delete n[Jf], delete n[qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Gu(t), n === 1))
      e.tag === 0 ? bf(Vi.bind(null, e)) : qs(Vi.bind(null, e)),
        Gf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Wa(e, n) {
  ...
  if (n !== 0) {
    if (
      ...
      throw ((t = Xt), Cn(e, 0), qe(e, r), de(e, W()), t);
    if (n === 6) qe(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = Nu + 500 - W()), 10 < n))
          ) {
            if (Ir(e, 0) !== 0) break;
            ...
            e.timeoutHandle = So(wn.bind(null, e, se, Ue), n);
            break;
          }
          wn(e, se, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = So(wn.bind(null, e, se, Ue), r);
            break;
          }
          wn(e, se, Ue);
          break;
...
function Vi(e) {
  ...
  if (t === 1) throw ((t = Xt), Cn(e, 0), qe(e, n), de(e, W()), t);
...
function Tu() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(zn & 268435455) && !(fl & 268435455)) || qe(Z, q);
}
function br(e, n) {
  var t = R;
  R |= 2;
  ...
  while (1);
  if ((du(), (R = t), (Zr.current = r), Q !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function wd() {
  for (; Q !== null; ) Ya(Q);
...
Za = function (e, n, t) {
  ...
  else (ae = !1), j && n.flags & 1048576 && bs(n, Hr, n.index);
  switch (((n.lanes = 0), n.tag)) {
    case 2:
      var r = n.type;
      Nr(e, n), (e = n.pendingProps);
      var l = qn(n, re.current);
      Gn(n, t), (l = Su(null, n, r, e, l, t));
      var o = ku();
      return (
        (n.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            No(n, r, e, t),
            (n = To(null, n, r, !0, o, t)))
          : ((n.tag = 0), j && o && su(n), le(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
...
function Tr(e, n, t, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Ru(e) && (u = 1);
    ...
    e: switch (e) {
      ...
      case Zl:
        return (
          (e = ke(12, t, n, l | 2)), (e.elementType = Zl), (e.lanes = o), e
        );
      case Jl:
        return (e = ke(13, t, n, l)), (e.elementType = Jl), (e.lanes = o), e;
      case ql:
        return (e = ke(19, t, n, l)), (e.elementType = ql), (e.lanes = o), e;
      case us:
        return dl(t, l, o, n);
      default:
...
function Td(e, n, t, r, l) {
  ...
  var s = Ou(e, 0, !1, null, null, !1, !1, "", Wi);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (eu(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ys = zu;
gs = Ln;
var Rd = { usingClientEntryPoint: !1, Events: [qt, Un, ul, vs, hs, zu] },
  ht = {
...
const Md = "/assets/do-a-barrel-roll-f99768ab.webp";
function Dd() {
  return be(es, {
    children: Nc("div", {
      className: "wrapper",
      children: [
        be("h1", { children: "Welcome To My App" }),
        be("p", {
          children: "This is going to be the coolest app in the world!",
        }),
        be("img", { src: Md, alt: "barrelRoll", width: 200, height: 200 }),
      ],
    }),
  });
}
function Id() {
  return be(es, { children: be(Dd, {}) });
}
Kl.createRoot(document.getElementById("root")).render(
  be(Sc.StrictMode, { children: be(Id, {}) })
);
